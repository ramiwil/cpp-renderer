...
class Light : public Object {
  public:
    ...
    Light(std::shared_ptr<Material> mat, const Vec3 &center, const Vec3 &_normal, float _l, float _w) : Object(mat), position(center) {
      position = center; normal = _normal; w = _w; l = _l;
