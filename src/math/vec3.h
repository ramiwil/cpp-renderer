...
class Vec3 {
  public:
	...
	HD float dot(const Vec3 &other) const { return x * other.x + y * other.y + z * other.z; }
	...
	HD Vec3 operator*(float scalar) const { return Vec3(x * scalar, y * scalar, z * scalar); }
	...
	HD Vec3 operator-(float scalar) { return Vec3(x - scalar, y - scalar, z - scalar); }
};
